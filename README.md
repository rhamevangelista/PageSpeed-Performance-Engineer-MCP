...
| 14 | `generate_wp_rocket_config` | WP Rocket settings JSON with Elementor/WooCommerce awareness |
| 15 | `generate_cloudflare_rules` | Cache Rules, Transform Rules, and settings guide |
| 16 | `compare_performance` | Before/after delta from two `analyze_website` JSON reports |
